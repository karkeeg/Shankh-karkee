...
const AccountSettings = ({ setSelectedUser, setStatus }) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-[20px] sm:p-[40px] space-y-[20px] sm:space-y-[30px] bg-white rounded-lg">
        <div
          style={{ fontFamily: "Poppins" }}
        ...
        <div>
          {active === "changePass" ? (
            <div
              ...
              className="space-y-[20px] sm:space-y-[30px]"
            >
              ...
              <div className="font-semibold flex flex-col space-y-4 sm:space-y-0 sm:space-x-[25px]">
                <span
                  style={{ fontFamily: "Poppins" }}
