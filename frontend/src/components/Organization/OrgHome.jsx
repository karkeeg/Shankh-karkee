...
const OrgHome = ({language, startDate, endDate, setStatus}) => {
  ...
  return (
    <div className='bg-[#E7F0F0] h-[89svh] p-2 w-full overflow-y-scroll'>
      <div className='bg-white shadow-md p-4 rounded-lg space-y-[20px]'>
        <h3 style={{fontFamily : "Poppins"}} className='text-[16px] sm:text-[18px] font-semibold'>Here is summary of user scores</h3>
        <div style={{fontFamily : "Poppins"}} className='grid gap-4 p-2 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4'>
          <div  className='w-full drop-shadow-lg  border-l-4 border-[#34856C] rounded-xl bg-white pl-[19px] pr-[32px] pt-[22px] h-[119px]'>
            <Tooltip title="Total number of attempts by the user within the selected time period." >
                <div className='flex'>
                <span className='font-semibold text-[#5F6C7B] text-[14px] sm:text-[16px]'>Total Attempts</span>
                <span className='items-top text-center text-white rounded-full bg-[#5F6C7B] w-[12px] text-[10px] h-[12px]'>i</span>
                </div>
            </Tooltip>
            <span className='text-[20px] sm:text-[24px] font-semibold'>{data.length}</span>
          </div>
          <div className='w-full border-l-4 border-[#34856C] rounded-xl bg-white pl-[19px] pr-[32px] drop-shadow-lg pt-[22px] h-[119px]'>
            <Tooltip title = "Average of all the scores of the user within the selected time period.">
                <div className='flex'>
                <span className='font-semibold text-[#5F6C7B] text-[14px] sm:text-[16px]'>Average Total Score</span>
                <span className='items-top text-center text-white rounded-full bg-[#5F6C7B] w-[12px] text-[10px] h-[12px]'>i</span>
                </div>
            </Tooltip>
            <span className='text-[20px] sm:text-[24px] font-semibold'>{Math.ceil(vocalAverage + behaviourAverage)/2}%</span>
          </div>
          <div className='w-full border-l-4 border-[#34856C] rounded-xl bg-white pl-[19px] pr-[32px] drop-shadow-lg pt-[22px] h-[119px]'>
            <Tooltip title = "Shows the mean performance score across all vocal analysis parameters including tone, pace, clarity, and speech patterns">
                <div className='flex'>
                <span className='font-semibold text-[#5F6C7B] text-[14px] sm:text-[16px]'>Vocal Insights Average</span>
                <span className='items-top text-center text-white rounded-full bg-[#5F6C7B] w-[12px] text-[10px] h-[12px]'>i</span>
                </div>
            </Tooltip>
            <span className='text-[20px] sm:text-[24px] font-semibold'>{Math.ceil(vocalAverage)}%</span>
          </div>
          <div className='w-full border-l-4 border-[#34856C] rounded-xl bg-white pl-[19px] pr-[32px] drop-shadow-lg pt-[22px] h-[119px]'>
            <Tooltip title = "Displays the average rating for behavioral assessment criteria such as confidence, engagement, body language, and presentation skills">
                <div className='flex'>
                <span className='font-semibold text-[#5F6C7B] text-[14px] sm:text-[16px]'>Behaviour Insights Average</span>
                <span className='items-top text-center text-white rounded-full bg-[#5F6C7B] w-[12px] text-[10px] h-[12px]'>i</span>
                </div>
            </Tooltip>
            <span className='text-[20px] sm:text-[24px] font-semibold'>{Math.ceil(behaviourAverage)}%</span>
          </div>
        </div>
        <Chart testData = {data} />
        <div  className='bg-white space-y-2 brightness-100 rounded-lg drop-shadow-lg w-full pl-[16px] sm:pl-[24px] pt-[16px] pr-[16px] sm:pr-[24px] pb-[16px]'>
            <h1 style={{fontFamily : "Poppins"}} className='text-[18px] sm:text-[20px] font-semibold'>Performance across Key Parameters</h1>
            <div style={{fontFamily : "Inter"}} className='grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8 text-[16px] sm:text-[18px]'>
                <div className='shadow-lg rounded-lg p-4 lg:p-[20px] w-full min-h-[300px] sm:min-h-[400px] flex flex-col'>
                    <h3 className='font-semibold mb-4 text-sm sm:text-base'>Voice Insights :<span className='font-medium'> The Mechanics of Impactful Speech</span></h3>
                    <div className='flex-1 flex items-center justify-center'>
                        <SpiderChart testData = {voiceAverages} />
                    </div>
                </div>
                <div className='shadow-lg rounded-lg p-4 lg:p-[20px] w-full min-h-[300px] sm:min-h-[400px] flex flex-col'>
                    <h3 className='font-semibold mb-4 text-sm sm:text-base'>Behavior Insights :<span className='font-medium'> The Psychology of your voice</span></h3>
                    <div className='flex-1 flex items-center justify-center'>
        ...
        <div style={{fontFamily : "Poppins"}} className='bg-white brightness-100 space-y-8 rounded-lg drop-shadow-lg w-full pl-[16px] sm:pl-[24px] pt-[16px] pr-[16px] sm:pr-[24px] pb-[16px]'>
            <h1 className='text-[18px] sm:text-[20px] font-semibold'>Detailed Voice Insights</h1>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                <div className='bg-white drop-shadow-lg rounded-lg pr-[15px] sm:pr-[25px] pb-[10px] pl-[15px] sm:pl-[25px] pt-[10px] '>
                    <div className='flex justify-between'>
                        <Tooltip title = "The smoothness and ease of speech, without hesitations or repetitions.">
                            <div className='flex justify-between'>
                                <span className='font-semibold text-[#5F6C7B] text-[14px] sm:text-[16px]'>Fluency</span>
                                <span className='items-top text-center text-white rounded-full bg-[#5F6C7B] w-[12px] text-[10px] h-[12px]'>i</span>
                            </div>
                        </Tooltip>
                        <span className={`text-[14px] sm:text-[16px] font-semibold ${voiceAverages["Fluency"] <= 39
                            ? "text-[#FF6B5B]"
                    ...
                    <div>
                        <span className="text-[20px] sm:text-[24px] font-semibold">{voiceAverages["Fluency"]}%</span>
                ...
                <div className='bg-white drop-shadow-lg rounded-lg pr-[15px] sm:pr-[25px] pb-[10px] pl-[15px] sm:pl-[25px] pt-[10px] '>
                    <div className='flex justify-between'>
                        <Tooltip title = "Evaluates articulation, pronunciation, and overall intelligibility of spoken words and phrases">
                            <div className='flex justify-between'>
                                <span className='font-semibold text-[#5F6C7B] text-[14px] sm:text-[16px]'>Clarity</span>
                                <span className='items-top text-center text-white rounded-full bg-[#5F6C7B] w-[12px] text-[10px] h-[12px]'>i</span>
                            </div>
                        </Tooltip>
                        <span className={`text-[14px] sm:text-[16px] font-semibold ${voiceAverages["Clarity"] <= 39
                            ? "text-[#FF6B5B]"
                    ...
                    <div>
                        <span className="text-[20px] sm:text-[24px] font-semibold">{voiceAverages["Clarity"]}%</span>
                        <div className="flex h-[10px] w-full rounded-l-full rounded-r-full bg-[#D9E0E6]">
                            <div
                ...
                <div className='bg-white drop-shadow-lg rounded-lg pr-[15px] sm:pr-[25px] pb-[10px] pl-[15px] sm:pl-[25px] pt-[10px] '>
                    <div className='flex justify-between'>
                        <Tooltip title = "The ability to vary pitch, volume, and rate to effectively communicate emotions and ideas">
                            <div className='flex justify-between'>
                                <span className='font-semibold text-[#5F6C7B] text-[14px] sm:text-[16px]'>Tone Modulation</span>
                                <span className='items-top text-center text-white rounded-full bg-[#5F6C7B] w-[12px] text-[10px] h-[12px]'>i</span>
                            </div>
                        </Tooltip>
                        <span className={`text-[14px] sm:text-[16px] font-semibold ${voiceAverages["Tone Modulation"] <= 39
                            ? "text-[#FF6B5B]"
                    ...
                    <div>
                        <span className="text-[20px] sm:text-[24px] font-semibold">{voiceAverages["Tone Modulation"]}%</span>
                        <div className="flex h-[10px] w-full rounded-l-full rounded-r-full bg-[#D9E0E6]">
                            <div
                ...
                <div className='bg-white drop-shadow-lg rounded-lg pr-[15px] sm:pr-[25px] pb-[10px] pl-[15px] sm:pl-[25px] pt-[10px] '>
                    <div className='flex justify-between'>
                        <Tooltip title = "The use of filler words, such as 'um' or 'uh', which can indicate a lack of confidence or preparation.">
                            <div className='flex justify-between'>
                                <span className='font-semibold text-[#5F6C7B] text-[14px] sm:text-[16px]'>Filler Words</span>
                                <span className='items-top text-center text-white rounded-full bg-[#5F6C7B] w-[12px] text-[10px] h-[12px]'>i</span>
                            </div>
                        </Tooltip>
                        <span className={`text-[14px] sm:text-[16px] font-semibold ${voiceAverages["Filler Words"] <= 39
                            ? "text-[#FF6B5B]"
                    ...
                    <div>
                        <span className="text-[20px] sm:text-[24px] font-semibold">{voiceAverages["Filler Words"]}%</span>
                        <div className="flex h-[10px] w-full rounded-l-full rounded-r-full bg-[#D9E0E6]">
                            <div
        ...
        <div style={{fontFamily : "Poppins"}} className='bg-white brightness-100 space-y-8 rounded-lg drop-shadow-lg w-full pl-[16px] sm:pl-[24px] pt-[16px] pr-[16px] sm:pr-[24px] pb-[16px]'>
            <h1 className='text-[18px] sm:text-[20px] font-semibold'>Detailed Behavior Insights</h1>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                <div className='bg-white drop-shadow-lg rounded-lg pr-[15px] sm:pr-[25px] pb-[10px] pl-[15px] sm:pl-[25px] pt-[10px] '>
                    <div className='flex justify-between'>
                        <Tooltip title = "The ability to effectively manage and express emotions in a professional setting.">
                            <div className='flex justify-between'>
                                <span className='font-semibold text-[#5F6C7B] text-[14px] sm:text-[16px]'>Emotional Regulation</span>
                                <span className='items-top text-center text-white rounded-full bg-[#5F6C7B] w-[12px] text-[10px] h-[12px]'>i</span>
                            </div>
                        </Tooltip>
                        <span className={`text-[14px] sm:text-[16px] font-semibold ${behaviorAverages["Emotional Regulation"] <= 39
                            ? "text-[#FF6B5B]"
                    ...
                    <div>
                        <span className="text-[20px] sm:text-[24px] font-semibold">{behaviorAverages["Emotional Regulation"]}%</span>
                        <div className="flex h-[10px] w-full rounded-l-full rounded-r-full bg-[#D9E0E6]">
                            <div
                ...
                <div className='bg-white drop-shadow-lg rounded-lg pr-[15px] sm:pr-[25px] pb-[10px] pl-[15px] sm:pl-[25px] pt-[10px] '>
                    <div className='flex justify-between'>
                        <Tooltip title = "Evaluates vocal authority, self-assurance, and commanding presence conveyed through speech patterns">
                            <div className='flex justify-between'>
                                <span className='font-semibold text-[#5F6C7B] text-[14px] sm:text-[16px]'>Confidence & Presence</span>
                                <span className='items-top text-center text-white rounded-full bg-[#5F6C7B] w-[12px] text-[10px] h-[12px]'>i</span>
                            </div>
                        </Tooltip>
                        <span className={`text-[14px] sm:text-[16px] font-semibold ${behaviorAverages["Confidence and Presence"] <= 39
                            ? "text-[#FF6B5B]"
                    ...
                    <div>
                        <span className="text-[20px] sm:text-[24px] font-semibold">{behaviorAverages["Confidence and Presence"]}%</span>
                        <div className="flex h-[10px] w-full rounded-l-full rounded-r-full bg-[#D9E0E6]">
                            <div
                ...
                <div className='bg-white drop-shadow-lg rounded-lg pr-[15px] sm:pr-[25px] pb-[10px] pl-[15px] sm:pl-[25px] pt-[10px] '>
                    <div className='flex justify-between'>
                        <Tooltip title = "Analyzes speech rhythm, strategic use of silence, and appropriate timing for emphasis and comprehension">
                            <div className='flex justify-between'>
                                <span className='font-semibold text-[#5F6C7B] text-[14px] sm:text-[16px]'>Pacing And Pauses</span>
                                <span className='items-top text-center text-white rounded-full bg-[#5F6C7B] w-[12px] text-[10px] h-[12px]'>i</span>
                            </div>
                        </Tooltip>
                        <span className={`text-[14px] sm:text-[16px] font-semibold ${behaviorAverages["Pacing and Pauses"] <= 39
                            ? "text-[#FF6B5B]"
                    ...
                    <div>
                        <span className="text-[20px] sm:text-[24px] font-semibold">{behaviorAverages["Pacing and Pauses"]}%</span>
                        <div className="flex h-[10px] w-full rounded-l-full rounded-r-full bg-[#D9E0E6]">
                            <div
                ...
                <div className='bg-white drop-shadow-lg rounded-lg pr-[15px] sm:pr-[25px] pb-[10px] pl-[15px] sm:pl-[25px] pt-[10px] '>
                    <div className='flex justify-between'>
                        <Tooltip title = "Assesses ability to capture and maintain audience attention through dynamic and interactive vocal delivery">
                            <div className='flex justify-between'>
                                <span className='font-semibold text-[#5F6C7B] text-[14px] sm:text-[16px]'>Engagement</span>
                                <span className='items-top text-center text-white rounded-full bg-[#5F6C7B] w-[12px] text-[10px] h-[12px]'>i</span>
                            </div>
                        </Tooltip>
                        <span className={`text-[14px] sm:text-[16px] font-semibold ${behaviorAverages["Engagement"] <= 39
                            ? "text-[#FF6B5B]"
                    ...
                    <div>
                        <span className="text-[20px] sm:text-[24px] font-semibold">{behaviorAverages["Engagement"]}%</span>
                        <div className="flex h-[10px] w-full rounded-l-full rounded-r-full bg-[#D9E0E6]">
                            <div
        ...
        <div className='bg-white brightness-100 space-y-8 rounded-lg drop-shadow-lg w-full pl-[16px] sm:pl-[24px] pt-[16px] pr-[16px] sm:pr-[24px] pb-[16px]'>
              <div className='flex flex-col sm:flex-row justify-between space-y-4 sm:space-y-0'>
                <h1 style={{fontFamily : "Poppins"}} className='text-[18px] sm:text-[20px] font-semibold'>Recent Tests</h1>
                <button onClick={() => setViewAll((prev) => !prev)} className='border w-full sm:w-[199px] hover:bg-[#34856C] cursor-pointer hover:text-white rounded-lg font-semibold pt-[10px] text-[14px] sm:text-[16px] pb-[10px] pl-[20px] sm:pl-[53px] pr-[20px] sm:pr-[53px] text-[#34856C] border-[#34856C]'>{viewAll ? "View Less" : "View All"}</button>
              </div>
            <div className="overflow-x-auto">
              <table style={{fontFamily : "Inter"}} className="w-full text-[14px] sm:text-[18px] min-w-[600px]">
                  <thead>
                  ...
                  <tbody>
                      {data ? data.map((item, index) => {
                          ...
                          return (
                              <tr key={index} className='pt-2 border-b-[1px] border-gray-300 text-center pr-8 pl-8 pb-2 w-full '>
