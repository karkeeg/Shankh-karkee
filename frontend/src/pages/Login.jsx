    ...
    >
      ...
      >
        ...
        <div className="inline-grid space-y-1">
          ...
          <button className=" w-[300px] cursor-pointer text-center rounded-lg bg-[#FF6B5B] text-white font-semibold pr-[53px] text-[16px] pb-[10px] pl-[53px] pt-[10px]">
            Login
          </button>
        </div>
        <span style={{ fontFamily: "Inter" }} className="text-[14px]">
          Not a member?{" "}
          <NavLink to={"/signUp"} className="text-[#34856C]">
            Register Now
          </NavLink>
        </span>
      </motion.div>
