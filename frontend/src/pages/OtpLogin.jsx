  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data: res } = await axios.post(url, {
        ...
        otp: otp1.dig1 + otp1.dig2 + otp1.dig3 + otp1.dig4,
      });
      console.log(res);
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-[700px] rounded-xl relative pt-[30px] pr-[76px] pb-[30px] bg-white pl-[76px]  flex flex-col space-y-[20px] justify-center h-[450px]"
      >
        ...
        <div className="space-x-[26.8px]">
          <input
            ...
            className="h-[50px] w-[50px] text-lg rounded-lg items-center border-1 p-2"
            type="text"
            pattern="[0-9]"
            maxlength="1"
            inputmode="numeric"
        ...
        <div className="inline-grid space-y-1">
          ...
          <button
            style={{ fontFamily: "Poppins" }}
            className=" w-[300px] cursor-pointer  rounded-lg bg-[#FF6B5B] text-white font-semibold pr-[53px] text-[16px] pb-[10px] pl-[53px] pt-[10px]"
          >
            Register{" "}
          </button>
        </div>
        <span style={{ fontFamily: "Poppins" }} className="text-[14px]">
          Didn't receive OTP?{" "}
          <button onClick={handleResend} className="text-[#34856C]">
            Send Again
          </button>
        </span>
      </motion.div>
